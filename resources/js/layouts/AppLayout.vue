<template>
    <div class="flex min-h-screen bg-gray-50">
        <!-- Сайдбар -->
        <aside
            class="fixed flex h-full w-60 flex-col border-r border-panel bg-panel px-4 py-6 shadow-panel"
        >
            ...
            <nav class="flex flex-col gap-1 text-app">
                <div
                    class="shadow-link mb-2 flex items-center gap-2 rounded-2xl bg-white px-2 py-4 text-sm tracking-wide font-medium"
                >
                    <svg
                        width="16"
                        height="16"
        ...
        <!-- Основной контент -->
        <div class="ml-60 flex flex-1 flex-col bg-white">
            <header
                class="flex h-14 items-center justify-end border-b border-gray-200 bg-white px-6"
            >
                <Link
                    :href="logout.url()"
                    method="post"
